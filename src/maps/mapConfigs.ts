// Per-map render config. Transform/rotation/bounds/svgPath values are lifted from
// tarkov.dev's src/data/maps.json (the "interactive" variant of each map). The SVG
// assets are CC BY-NC-SA 4.0 (author: Shebuka / the-hideout). `key` matches both the
// maps.json key and the tarkov.dev GraphQL `normalizedName`.
